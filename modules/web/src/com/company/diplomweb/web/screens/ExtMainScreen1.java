...
@UiController("extMainScreen1")
@UiDescriptor("ext-main-screen1.xml")
public class ExtMainScreen1 extends MainScreen implements Window.HasFoldersPane {
    @Inject
